...
**Why probit?** The probit link assumes that underlying developmental readiness is normally distributed across individuals—a biologically intuitive interpretation. For a detailed derivation, see the [Probit Link section](vitalBayes_stats_explained.html#probit) in the Statistical Methods guide.
...
- [Statistical Methods: Birth Size Estimation](vitalBayes_stats_explained.html#birth) — Full mathematical derivation

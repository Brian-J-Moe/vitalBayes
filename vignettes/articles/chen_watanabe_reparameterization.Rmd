...
1. **$L_0$ parameterization**: Expressing the CW model directly in terms of length at birth $L_0$ and asymptotic length $L_\infty$, eliminating dependence on the theoretical parameter $t_0$.

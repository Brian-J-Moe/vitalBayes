---
title: "Maturity Ogive Estimation with fit_bayesian_maturity()"
output: rmarkdown::html_vignette
vignette: >
 %\VignetteIndexEntry{Maturity Ogive Estimation with fit_bayesian_maturity()}
...
Elasmobranch datasets often have imbalanced sex ratios. With 150 females but only 23 males, the male estimate would have very wide credible intervals if fit independently.
...
For a comprehensive treatment, see `vignette("partial_pooling")` or the [Partial Pooling section](vitalBayes_stats_explained.html#maturity) in the Statistical Methods guide.
...
- `vignette("partial_pooling")` — Detailed treatment of hierarchical modeling for imbalanced data
- [Statistical Methods: Maturity Estimation](vitalBayes_stats_explained.html#maturity) — Full mathematical derivation
- [Statistical Methods: Probit Link](vitalBayes_stats_explained.html#probit) — Why probit over logit
- `plot_maturity_ogive()` — Visualization
- `fit_bayesian_growth()` — Using maturity estimates in growth models

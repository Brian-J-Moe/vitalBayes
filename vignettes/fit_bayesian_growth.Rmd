...
For the full derivation, see the [Maturity-Based Parameterization section](vitalBayes_stats_explained.html#maturity-param) in the Statistical Methods guide.
...
**vitalBayes enforces** $L_\infty > L_{max}$ (the maximum observed length). For the biological and statistical rationale, see [Why $L_\infty$ Must Exceed Maximum Observed Length](vitalBayes_stats_explained.html#linf) in the Statistical Methods guide.
...
- [Statistical Methods: Growth Models](vitalBayes_stats_explained.html#growth) — Full mathematical derivation
- [Statistical Methods: Maturity-Based Parameterization](vitalBayes_stats_explained.html#maturity-param) — The key innovation
- [Statistical Methods: CV-Based Priors](vitalBayes_stats_explained.html#cv-priors) — How priors are specified

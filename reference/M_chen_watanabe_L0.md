...
- Linf_factor:
  ...
  \\t\_{max}\\. Default 0.99 (age at 99% of asymptotic length).
...
form becomes: \$\$M(t) = \frac{k \cdot L\_\infty}{L(t)}\$\$
...
proportional to body size - smaller (younger) individuals experience
higher mortality. The ratio \\L\_\infty / L(t)\\ represents how far an
individual is from asymptotic size, with mortality declining as this
ratio approaches 1.

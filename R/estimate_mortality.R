...
#' @param warn Logical. If \code{TRUE} (default
), warns when draws produce
...
#' }
#'
#' \subsection{Two-Phase Extension}{
...
#'
#' @details
#' \subsection{Growth Model Flexibility}{
...
#' }
#'
#' \subsection{Joint Posterior Sampling}{
